...
class LiveSearchNewAdPage1 extends StatelessWidget {
  LiveSearchNewAdPage1({Key? key}) : super(key: key);
  // File? source;
        ...
        return SingleChildScrollView(
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                AppText(
                  'add.liveSearchNewAdPage1.createNewAd',
                ...
                Padding(
                  ...
                  child: AppText(
                    'add.liveSearchNewAdPage1.title',
                ...
                Padding(
                  padding: const EdgeInsets.only(left: 5),
                  child: AppText(
                    'add.liveSearchNewAdPage1.description',
                    style: context.read<AppThemeCubit>().state.textTheme.inputLabelTextStyle,
                  ),
                ),
                AppTextFormField(
                ...
                Padding(
                  ...
                  child: SimpleButton(
                    ...
                    text: 'add.liveSearchNewAdPage1.nextStep',
                  ),
                ),
              ],
            ),
